  ...
  handleSubmit(e){
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        let time = this.props.form.getFieldValue(`tour_start_hour`)+':'+
  ...
  componentWillReceiveProps(nextProps){
    ...
    if(this.props.eachTour !== nextProps.eachTour){
      ...
      if(nextProps.eachTour){
        ...
        let parts = nextProps.eachTour.start_time.split(':')

        this.setState({start_time_hour:parts[0]})
        this.setState({start_time_min:parts[1]})
      }
    }
      ...
      <Col span={11} offset = {1}>
         ...
         >
            <Row>
             <Col span="3">
              <FormItem>
                {getFieldDecorator('tour_start_hour',{initialValue:this.state.start_time_hour},
                {
                  rules: [{
                   required: true
                 },
            ...
            <Col span="3">
              <FormItem>
                {getFieldDecorator('tour_start_minute',{initialValue:this.state.start_time_min},{
                  rules: [{
                   required: true
                 },
